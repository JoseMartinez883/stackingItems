...
/**
 * Prueba para verificar el buen funcionamiento del simulador ciclo 1
...
public class AcceptanceTest{
    ...
    public void casoAceptacion() {
        try {
            ...
            esperar("Intentaremos agregar tapa id 2 duplicada, pero dara error.");
            try {
                t.pushLid(2); 
            } catch (TowerException e) {
                esperar("Resultado esperado: " + e.getMessage());
            }
            ...
            esperar("Error fatal: " + e.getMessage());
        } catch (Exception e) {
                Log.record(e);
